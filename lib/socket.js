...
(function (exports, io) {
  ...
  Socket.prototype.reconnect = function () {
    ...
    function reset () {
      ...
      self.removeListener('connect_failed', reset);
    ...
    function reconnect () {
      ...
      if (self.connecting || self.handshaking) {
        reconnect.timeout = setTimeout(reconnect, 1000);
      }
      ...
      if (attempt < limit) {
        ...
        self.publish('reconnecting', timeout, attempts);
      } else {
        ...
        self.options['try multiple transports'] = multiple;
        self.once('connect_failed', reset);
