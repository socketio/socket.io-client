...
console.log('DVV:TRONPACKET', packet, this);
...
console.log('DVV:ONPACKET0', packet, this);
...
console.log('DVV:ONPACKET', packet, this);
    switch (packet.type) {
      case 'connect':
      case 'disconnect':
      ...
      case 'ack':
        if (this.acks[packet.ackId]) {
          this.acks[packet.ackId].apply(this.socket, packet.args);
