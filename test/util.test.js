...
(function (module, io, should) {
  ...
  module.exports = {
    ...
    'is array': function () {
      io.util.isArray([]).should.true;
      io.util.isArray({}).should.false;
      io.util.isArray('str').should.false;
      io.util.isArray(new Date).should.false;
      io.util.isArray(true).should.false;
      io.util.isArray(arguments).should.false;
    },
    ...
    'defer': function (next) {
      ...
      io.util.defer(function () {
        ((new Date - now) >= ( io.util.webkit ? 100 : 0 )).should.true;
        next();
      })
    },
