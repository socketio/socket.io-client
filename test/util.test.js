...
(function (module, io, should) {
  ...
  module.exports = {
    ...
    'is array': function () {
      io.util.isArray([]).should.be.true;
      io.util.isArray({}).should.be.false;
      io.util.isArray('str').should.be.false;
      io.util.isArray(new Date).should.be.false;
      io.util.isArray(true).should.be.false;
      io.util.isArray(arguments).should.be.false;
    },
    ...
    'defer': function (next) {
      ...
      io.util.defer(function () {
        ((new Date - now) >= ( io.util.webkit ? 100 : 0 )).should.be.true;
        next();
      })
    },
